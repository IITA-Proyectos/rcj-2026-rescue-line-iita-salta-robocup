                ...
                while(digitalRead(32) == 0){
                    ...
                    if(alineado){
                        ...
                        if(front_distance<12){
                            ...
                            if(left_distance < right_distance)
                            {
                                if(get_color()=="Rojo" || get_color()=="Verde"){
                                    runTime(0,FORWARD,0,1000);
                                    runAngle(25,FORWARD,150);
                                    runTime(25,BACKWARD,0,200);
                                    claw.depositRight();
                                    delay(1000);
                                }
                                else{
