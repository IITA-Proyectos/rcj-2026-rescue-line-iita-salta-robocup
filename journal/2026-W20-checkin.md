...
- **Hoy (18-may) ambos tracks en push libre.** Track A tiene 8 días de aire (hasta 26-may); Track B hasta 11-jun. La extensión descomprime el firmware/Laureano.
...
|----------|----------|------|
| Laureano (Laumonteros) | 🔴 | #105: timeouts revertidos sin arrancar — es la prioridad #1 crítica del proyecto |
...
- Reordena el énfasis: la deadline dura (19-5) es del frente firmware/Laureano; visión tiene ventana hasta 4-jun.
- Reparto del trabajo por persona en issues separados (#102 agenda, #103 consolidado, #104 Benjamin, #105 Laureano, #106 Enzo).
- Alerta de timeouts revertidos comentada en #60/#61/#62 (autorizada por Gustavo).
- Aclarado: Laureano = Laureano Monteros = `Laumonteros` (una persona).
...
- **Enzo (#106):** mergear #101 → cerrar triage #91 (vence 17) → distribuir #104/#105 → cuidar que Laureano arranque por timeouts.
- **Laureano (#105):** re-aplicar timeouts incremental (PRIORIDAD #1) → T-A get_color → T-B taskDone → #58 break.
