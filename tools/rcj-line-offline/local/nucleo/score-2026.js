 ...
 * CALC: helper/scoreCalculatorRules/2026.js del CMS (commit d805502) copiado VERBATIM completo
 * (calculateLineScore:8-95; calculateMazeScore queda incluido pero no se usa).
 * Despachador: helper/scoreCalculator.js:12-19 VERBATIM, con `rules` estático {'2026': ...} en lugar
 * de fs.readdirSync/require dinámico y LEAGUES_JSON = leagues.json VERBATIM.
 */
(function () {
...
// ===== INICIO VERBATIM helper/scoreCalculatorRules/2026.js (rcj-rescue-cms d805502) =====
...
// ===== FIN VERBATIM helper/scoreCalculatorRules/2026.js =====

    reglas['2026'] = module.exports;
  })();
  ...
  (function () {
    ...
    var rules = reglas;
    const LEAGUES_JSON =
// ===== INICIO VERBATIM leagues.json (rcj-rescue-cms d805502) =====
[
  {
    "type": "line",
    "id": "Line",
...
// ===== FIN VERBATIM leagues.json =====
    ;

// ===== INICIO VERBATIM helper/scoreCalculator.js:12-19 (rcj-rescue-cms d805502) =====
...
// ===== FIN VERBATIM helper/scoreCalculator.js:12-19 =====

    window.RCJLocal.LEAGUES_JSON = LEAGUES_JSON;
    window.RCJLocal.calculateScore = module.exports.calculateScore;
  })();

  window.RCJLocal.reglasPuntaje = reglas;
  window.RCJLocal.calculateLineScore = reglas['2026'].calculateLineScore;
})();
