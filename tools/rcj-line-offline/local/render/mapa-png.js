 ...
 * PNG del mapa (E8 map-image-png, y la imagen que usan el PDF de mapa y la planilla):
 * port de helper/lineSSR/2026.js y helper/lineSSR/index.js (CMS d805502) a <canvas>.
 *
 * El código del CMS va entre marcas VERBATIM (lo inserta y lo verifica
 * tests/salidas-verbatim.py con `git show d805502:<ruta>`). Únicos cambios, marcados
 * [rcj-line-offline] en la misma línea (detalle en cambios/salidas.md):
 *   - 2026.js:22   fs.existsSync(...)  -> await fs.existe(...)   (fetch asíncrono)
 *   - 2026.js:308  canvas.toBuffer(...) -> await canvas.toBuffer(...)
 *   - 2026.js:313  (...).toBuffer(...) -> await (...).toBuffer(...)
 * @napi-rs/canvas, path y fs los provee local/render/comun.js.
 */
(function (global) {
  var S = global.RCJLocal && global.RCJLocal.salidas;
  if (!S || !S.comun) throw new Error('local/render/mapa-png.js: falta local/render/comun.js (incluir solo local/render/registrar.js; carga el resto bajo demanda)');
  var C = S.comun;

  // ---------------------------------------------------------------- helper/lineSSR/2026.js
  var m2026 = C.modulo('helper/lineSSR/2026');
  (function (module, exports, require, __dirname, __filename) {
// ===== INICIO VERBATIM helper/lineSSR/2026.js:1-320 =====
"use strict";
...
// ===== FIN VERBATIM helper/lineSSR/2026.js:1-320 =====
  })(m2026, m2026.exports, C.requireDe({
    '@napi-rs/canvas': C.canvas,
    'path': C.path,
    'fs': C.fs
  }), 'helper/lineSSR', 'helper/lineSSR/2026.js');
  C.publicar(m2026);

  // ---------------------------------------------------------------- helper/lineSSR/index.js
  var mIndex = C.modulo('helper/lineSSR');
  (function (module, exports, require, __dirname, __filename) {
// ===== INICIO VERBATIM helper/lineSSR/index.js:1-32 =====
...
// ===== FIN VERBATIM helper/lineSSR/index.js:1-32 =====
  })(mIndex, mIndex.exports, C.requireDe({
    '../../config/logger': { mainLogger: C.logger },
    './2026': 'helper/lineSSR/2026'
  }), 'helper/lineSSR', 'helper/lineSSR/index.js');
  C.publicar(mIndex);

  S.modulosCargados = S.modulosCargados || {};
  S.modulosCargados['local/render/mapa-png.js'] = true;
})(window);
