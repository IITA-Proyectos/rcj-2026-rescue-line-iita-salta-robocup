 ...
 * PDF de mapas (E8 map-image-pdf y export type=maps): port de helper/lineMapPDF.js (CMS d805502)
 * sobre components/pdfkit 0.12.3 standalone (misma versión que el CMS). Sin cambios de lógica:
 * el código va entre marcas VERBATIM (tests/salidas-verbatim.py). pdfkit, fs y path los provee
 * local/render/comun.js; `res` es la respuesta emulada de Express.
 */
(function (global) {
  var S = global.RCJLocal && global.RCJLocal.salidas;
  if (!S || !S.comun) throw new Error('local/render/mapa-pdf.js: falta local/render/comun.js (incluir solo local/render/registrar.js)');
  var C = S.comun;

  var mPDF = C.modulo('helper/lineMapPDF');
  (function (module, exports, require, __dirname, __filename) {
// ===== INICIO VERBATIM helper/lineMapPDF.js:1-86 =====
...
// ===== FIN VERBATIM helper/lineMapPDF.js:1-86 =====
  })(mPDF, mPDF.exports, C.requireDe({
    'pdfkit': C.PDFDocument,
    'fs': C.fs,
    'path': C.path,
    './lineSSR': 'helper/lineSSR'
  }), 'helper', 'helper/lineMapPDF.js');
  C.publicar(mPDF);

  S.modulosCargados = S.modulosCargados || {};
  S.modulosCargados['local/render/mapa-pdf.js'] = true;
})(window);
