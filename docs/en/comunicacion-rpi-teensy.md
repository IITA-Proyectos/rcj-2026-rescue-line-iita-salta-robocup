...
| 10 | Red line (in line) | In Raspberry, 10 is sent, but Teensy does not use 10 directly; it detects it as a visual event and follows its line logic. |
